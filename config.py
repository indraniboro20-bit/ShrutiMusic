...
BOT_USERNAME = os.getenv("BOT_USERNAME", "kitkatxmusicbot")
...
UPSTREAM_REPO = os.getenv("UPSTREAM_REPO", "http://github.com/indraniboro20-bit/ShrutiMusic")
UPSTREAM_BRANCH = os.getenv("UPSTREAM_BRANCH", "main")
GIT_TOKEN = os.getenv("GIT_TOKEN", None)

SUPPORT_CHANNEL = os.getenv("SUPPORT_CHANNEL", "https://t.me/ABOUT_ROLEX_ANU")
SUPPORT_GROUP = os.getenv("SUPPORT_GROUP", "https://t.me/+91aOX5qWDBZiM2E0")
INSTAGRAM = os.getenv("INSTAGRAM", "https://t.me/ABOUT_ROLEX_ANU")
YOUTUBE = os.getenv("YOUTUBE", "https://t.me/ABOUT_ROLEX_ANU")
GITHUB = os.getenv("GITHUB", "http://github.com/indraniboro20-bit/ShrutiMusic")
...
START_IMG_URL = os.getenv("START_IMG_URL", "https://postimg.cc/3WpZTNBv")
PING_IMG_URL = "https://postimg.cc/3WpZTNBv"
